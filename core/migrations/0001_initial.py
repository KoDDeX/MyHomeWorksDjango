    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('not_approved', 'Не подтверждено'), ('approved', 'Подтверждено'), ('completed', 'Выполнено'), ('cancelled', 'Отменено')], default='not_approved', max_length=50, verbose_name='Статус')),
